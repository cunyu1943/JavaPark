...
![](assets/20220612-docsify/format,png-20240216200743375.png)
...
![](assets/20220612-docsify/format,png-20240216200743389.png)
...
![](assets/20220612-docsify/format,png-20240216200743412.png)

![](assets/20220612-docsify/format,png-20240216200743254.png)
...
![](assets/20220612-docsify/format,png-20240216200743249.png)

### 封面

上述配置中封面已经打开，即 `coverpage: true`，此时新建一个 `_coverpage.md` 文件，在其中加入你所要显示的内容，比如我的封面；

![](assets/20220612-docsify/format,png-20240216200743437.png)

### 主页内容

即 `README.md` 的内容，比如我的最终结果显示如下；

![](assets/20220612-docsify/format,png-20240216200743376.png)
...
![](assets/20220612-docsify/format,png-20240216200743311.png)

### 提交项目

将本地的项目提交到远程；

![](assets/20220612-docsify/format,png-20240216200743358.png)

### 预览

在浏览器中访问创建仓库时的给的网址即可在线预览我们的网站了，比如我的是：`https://cunyu1943.github.io/cunyu1943`，默认会显示封面页；

![](assets/20220612-docsify/format,png-20240216200743431.png)
