...
![](assets/20210808-log-crud/eafc4ae5b2e4bd3bc2695e14daca8cb6.png)

-   **数据插入后的数据库**

![](assets/20210808-log-crud/2bec29287ff01a73aaf20f8c23afe19a.png)
...
![](assets/20210808-log-crud/86a6bc3c0f430dab4efdcb583ddde74a.png)
...
![](assets/20210808-log-crud/0c43ff686889a7ad13040a12bd011f6a.png)
...
![](assets/20210808-log-crud/efa9b05a272b232f6ea259c8d3054e42.png)
...
![](assets/20210808-log-crud/21bdde18446f1bc7ec886ec01e0aa8bc.png)

-   **数据更新后的数据库**

![](assets/20210808-log-crud/0bf78710d200c2f7535ade0f232646ea.png)
...
![](assets/20210808-log-crud/13fa53d7ce388606a0dba6caa7884791.png)

-   **删除数据后的数据库**

![](assets/20210808-log-crud/754b2aa42b70340c6d1ef359bf4957a1.png)
...
![](assets/20210808-log-crud/8ae3056bfe18e6a4f745a6c9ff509a30.png)

-   **删除数据后的数据库**

![](assets/20210808-log-crud/0e4ce5565c45b3af2113ba6fa265ae85.png)
...
![](assets/20210808-log-crud/7781d31edd822234ef741751cc84403d.png)

-   **删除数据后的数据库**

![](assets/20210808-log-crud/8ca0e6de77b33e31d83ac08480f40b5e.png)

## Service CRUD 接口

`Service` 层继承自 `IService` 接口，其中的方法和 `Mapper` 层中所提供的方法功能是一致的，除了方法名有所不同外，其他基本类似，但 `Service` 层中提供了更为丰富的方法，两者的继承结构如下图所示。

<img src="assets/20210808-log-crud/12764416856e4a9194c4b7046683ecd4~tplv-k3u1fbpfcp-zoom-1.image" style="zoom:150%;" />
...
![](assets/20210808-log-crud/5996487ba47a09711b90c00741733206.png)

-   **插入数据后的数据库**

![](assets/20210808-log-crud/d074edd870e74a751570e165a2b442e3.png)
...
![](assets/20210808-log-crud/cc5f359bcbb2d4287e51e693c64320b5.png)

-   **统一插入后的数据库**

![](assets/20210808-log-crud/99b83c2bb2e50f9b687d2ccafe694a6c.png)
...
![](assets/20210808-log-crud/176bd864bf1fdeaa40b52a971a0c6bf0.png)

-   **分批次插入后的数据库**

![](assets/20210808-log-crud/3cf55bdf99d6ca96218127840beb604a.png)
...
![](assets/20210808-log-crud/1bd07adc6afb9fa346f56563b97f3d20.png)

-   **修改插入后的数据库**

![](assets/20210808-log-crud/28761dbe6cb714bec1758a759fe5ec8b.png)
...
![](assets/20210808-log-crud/882f141e5b1b562300fd340e99dd1e74.png)

-   **统一插入数据后的数据库**

![](assets/20210808-log-crud/ea95b0aef97d6fc8911c4de46dbdc9d6.png)
...
![](assets/20210808-log-crud/bb54a447984342587c7f179565fa04bd.png)

-   **分批次插入数据后的数据库**

![](assets/20210808-log-crud/d165237c3ffaff0011de68da405520dc.png)
...
![](assets/20210808-log-crud/4f28d3ad476649f51c2d21ca67575b4c.png)

![](assets/20210808-log-crud/43147f95524c777df4ca9b6c9534f2bf.png)
...
![](assets/20210808-log-crud/3b281656c97119c48bcc67ae039dd43f.png)

-   **按条件删除后的数据库**

![](assets/20210808-log-crud/e00c5eec6db5fb177385f916593a5ddf.png)
...
![](assets/20210808-log-crud/36a48ba2fee8f6a5800b14a36020a96a.png)

-   **批量删除后的数据库**

![](assets/20210808-log-crud/c3a783950d27aa75ae82a123cad3955b.png)
...
![](assets/20210808-log-crud/21c7a6ffa9423f11939a36d00b249933.png)

-   **更新后的数据库**

![](assets/20210808-log-crud/e2c6861eb9678452797bb6373e430b71.png)
...
![](assets/20210808-log-crud/1ceaa41986d6c4df67c64613b13f292f.png)

-   **批量更新后的数据库**

![](assets/20210808-log-crud/4c610fff64f2d26ecdde6de141613e7b.png)
...
![](assets/20210808-log-crud/f1adac18df09758c69dae5b98eecb8bc.png)

-   **分批次更新后的数据库**

![](assets/20210808-log-crud/68924264cc41e5c2d46d432dc2e33149.png)
...
![](assets/20210808-log-crud/3590f21fa1cc05fb37090df84129487e.png)
...
![](assets/20210808-log-crud/0d603e74557b79206aaf184530f41007.png)
...
![](assets/20210808-log-crud/13e0ccaf7974bde5b83c98bd9c00a5e9.png)
...
![](assets/20210808-log-crud/83c2fbbe1dd98236217aecee73168797.png)
...
![](assets/20210808-log-crud/ca254977c9086653ab4b422b8809834c.png)
...
![](assets/20210808-log-crud/22fba4882741eaeee5c940d77b0131dc.png)
...
![](assets/20210808-log-crud/b79542a84e068a734cb25be93500e83c.png)
