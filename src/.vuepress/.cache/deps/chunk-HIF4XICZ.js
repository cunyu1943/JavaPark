...
// node_modules/.pnpm/mermaid@10.3.1/node_modules/mermaid/dist/createText-c64d47ca.js
function Tt(n, r) {
...
function Nt(n) {
  ...
  function x(F) {
    return r.parser.lazy[r.now().line] = e !== t.length, i = r.now().offset, k2(F);
  }
  function g(F) {
...
function $t(n, r, t) {
  ...
  return u;
  function u(k2) {
    return n.enter("autolink"), n.enter("autolinkMarker"), n.consume(k2), n.exit("autolinkMarker"), n.enter("autolinkProtocol"), l;
  }
  function l(k2) {
    return tn(k2) ? (n.consume(k2), i) : Vn(k2) ? p(k2) : t(k2);
  }
  function i(k2) {
    return k2 === 43 || k2 === 45 || k2 === 46 || v(k2) ? a(k2) : p(k2);
  }
  function a(k2) {
    return k2 === 58 ? (n.consume(k2), c) : (k2 === 43 || k2 === 45 || k2 === 46 || v(k2)) && e++ < 32 ? (n.consume(k2), a) : p(k2);
  }
  function c(k2) {
    return k2 === 62 ? (n.exit("autolinkProtocol"), f(k2)) : k2 === null || k2 === 32 || k2 === 60 || zn(k2) ? t(k2) : (n.consume(k2), c);
  }
  function p(k2) {
    return k2 === 64 ? (n.consume(k2), e = 0, h) : Vn(k2) ? (n.consume(k2), p) : t(k2);
  }
  function h(k2) {
    return v(k2) ? x(k2) : t(k2);
  }
  function x(k2) {
    return k2 === 46 ? (n.consume(k2), e = 0, h) : k2 === 62 ? (n.exit("autolinkProtocol").type = "autolinkEmail", f(k2)) : g(k2);
  }
  function g(k2) {
    return (k2 === 45 || v(k2)) && e++ < 63 ? (n.consume(k2), k2 === 45 ? g : x) : t(k2);
  }
  function f(k2) {
    return n.enter("autolinkMarker"), n.consume(k2), n.exit("autolinkMarker"), n.exit("autolink"), r;
  }
}
var Sn = {
  tokenize: Zt,
...
function vt(n, r, t) {
  ...
  function f(d) {
    return d === null || Y(d) ? (n.exit("chunkString"), n.exit("codeFencedFenceInfo"), T(n, k2, "whitespace")(d)) : d === 96 && d === p ? t(d) : (n.consume(d), f);
  }
  function k2(d) {
...
function ae(n, r) {
  ...
  for (g = -1; ++g < c.length; )
    p[k2 + c[g][0]] = k2 + c[g][1], k2 += c[g][1] - c[g][0] - 1;
  return p;
}
var oe = {
  tokenize: he,
...
function ut(n, r, t, e, u, l, i, a, c) {
  ...
  function f(y) {
    return y === 62 ? (n.exit("chunkString"), n.exit(a), g(y)) : y === null || y === 60 || C(y) ? t(y) : (n.consume(y), y === 92 ? k2 : f);
  }
  function k2(y) {
...
function Ae(n, r, t) {
  ...
  function h(o) {
    return o === 33 ? (n.consume(o), x) : o === 47 ? (n.consume(o), k2) : o === 63 ? (n.consume(o), u = 3, e.interrupt ? r : U) : tn(o) ? (n.consume(o), i = String.fromCharCode(o), l = true, B) : t(o);
  }
  function x(o) {
...
function Te(n, r, t) {
  ...
  function g(s) {
    return s === null || s === 62 ? t(s) : s === 45 ? (n.consume(s), f) : k2(s);
  }
  function f(s) {
    return s === null || s === 62 ? t(s) : k2(s);
  }
  function k2(s) {
    return s === null ? t(s) : s === 45 ? (n.consume(s), B) : C(s) ? (a = k2, W(s)) : (n.consume(s), k2);
  }
  function B(s) {
    return s === 45 ? (n.consume(s), H) : k2(s);
  }
  function D(s) {
...
function Ze(n, r, t) {
  ...
  return a;
  function a(f) {
    const k2 = e.containerState.type || (f === 42 || f === 43 || f === 45 ? "listUnordered" : "listOrdered");
    if (k2 === "listUnordered" ? !e.containerState.marker || f === e.containerState.marker : An(f)) {
      if (e.containerState.type || (e.containerState.type = k2, n.enter(k2, {
        _container: true
      })), k2 === "listUnordered")
...
function lr(n, r, t) {
  ...
  function F(S, E) {
    const A = E || {};
    return A.type = S, A.start = k2(), p.events.push(["enter", A, p]), a.push(A), A;
  }
  function L(S) {
    const E = a.pop();
    return E.end = k2(), p.events.push(["exit", E, p]), E;
  }
  function O(S, E) {
    j(S, E.from);
  }
  ...
  function R() {
    const S = k2(), E = p.previous, A = p.currentConstruct, Q = p.events.length, G = Array.from(a);
    return {
      restore: nn,
      from: Q
    };
...
function Cr(n) {
  ...
  function u(m, b, w) {
    ...
    for (; ++z <= w; ) {
      ...
      if (M[1].type === "listUnordered" || M[1].type === "listOrdered" || M[1].type === "blockQuote" ? (M[0] === "enter" ? I++ : I--, kn = void 0) : M[1].type === "lineEndingBlank" ? M[0] === "enter" && (an && !kn && !I && !gn && (gn = z), kn = void 0) : M[1].type === "linePrefix" || M[1].type === "listItemValue" || M[1].type === "listItemMarker" || M[1].type === "listItemPrefix" || M[1].type === "listItemPrefixWhitespace" || (kn = void 0), !I && M[0] === "enter" && M[1].type === "listItemPrefix" || I === -1 && M[0] === "exit" && (M[1].type === "listUnordered" || M[1].type === "listOrdered")) {
        ...
        }, m.splice(z, 0, ["enter", an, M[2]]), z++, w++, gn = void 0, kn = true);
      }
    }
  ...
  function s() {
    ...
    if (l("inReference", true), w.type === "link") {
      const z = m.children;
      w.children = z;
    } else
      w.alt = b;
...
var Rr = (n, r = "", {
  ...
  if (k.info("createText", r, t, e, u, l, i, c), l) {
    const p = Tr(r), h = {
      isNode: i,
      label: hx(p).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
//# sourceMappingURL=chunk-HIF4XICZ.js.map
