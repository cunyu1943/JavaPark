...
// node_modules/.pnpm/mermaid@10.3.1/node_modules/mermaid/dist/infoDiagram-a7376644.js
var O = function() {
...
var G = (a, f, m) => {
  k.debug(`rendering info diagram
` + a);
  const k2 = ly(f);
  Fa(k2, 100, 400, true), k2.append("g").append("text").attr("x", 100).attr("y", 40).attr("class", "version").attr("font-size", 32).style("text-anchor", "middle").text(`v${m}`);
};
var H = { draw: G };
var K = {
  parser: V,
...
//# sourceMappingURL=infoDiagram-a7376644-RWHYPAYQ.js.map
