...
var he = (t) => {
  k.info("Setting root doc", t), lt = t;
};
var ue = () => lt;
var ct = (t, s, n) => {
  if (s.stmt === Rt)
...
var fe = (t) => {
  let s;
  t.doc ? s = t.doc : s = t, k.info(s), Yt(true), k.info("Extract", s), s.forEach((n) => {
    switch (n.stmt) {
      case Tt:
        I(
          n.id.trim(),
...
var I = function(t, s = xt, n = null, h = null, u = null, f = null, p = null, v = null) {
  ...
  g.states[d] === void 0 ? (k.info("Adding state ", d, h), g.states[d] = {
    id: d,
    descriptions: [],
    type: s,
    doc: n,
    ...
    styles: [],
    textStyles: []
  }) : (g.states[d].doc || (g.states[d].doc = n), g.states[d].type || (g.states[d].type = s)), h && (k.info("Setting state description", d, h), typeof h == "string" && Et(d, h.trim()), typeof h == "object" && h.forEach((k2) => Et(d, k2.trim()))), u && (g.states[d].note = u, g.states[d].note.text = Bn.sanitizeText(
    g.states[d].note.text,
    Ft()
  )), f && (k.info("Setting state classes", d, f), (typeof f == "string" ? [f] : f).forEach((T) => Dt(d, T.trim()))), p && (k.info("Setting state styles", d, p), (typeof p == "string" ? [p] : p).forEach((T) => Ee(d, T.trim()))), v && (k.info("Setting state styles", d, p), (typeof v == "string" ? [v] : v).forEach((T) => xe(d, T.trim())));
};
var Yt = function(t) {
  ot = {
    root: Ft2()
  }, g = ot.root, V = 0, P = Pt(), t || La();
};
var F = function(t) {
  return g.states[t];
};
...
function me(t, s, n) {
  ...
  I(
    ...
    id1: h,
    id2: f,
    relationTitle: Bn.sanitizeText(n, Ft())
  });
}
var Gt = function(t, s, n) {
  if (typeof t == "object")
    ...
    I(h, u), I(f, p), g.relations.push({
      id1: h,
      id2: f,
      title: Bn.sanitizeText(n, Ft())
    });
  }
};
var Et = function(t, s) {
  const n = g.states[t], h = s.startsWith(":") ? s.replace(":", "").trim() : s;
  n.descriptions.push(Bn.sanitizeText(h, Ft()));
};
var Te = function(t) {
...
//# sourceMappingURL=chunk-6QFQKSWR.js.map
