...
// node_modules/.pnpm/mermaid@10.3.1/node_modules/mermaid/dist/journeyDiagram-4884cc8d.js
var Z = function() {
...
var It = function() {
  J.length = 0, N.length = 0, L = "", B.length = 0, La();
};
var At = function(t) {
  L = t, J.push(t);
};
...
var Ht = function(t, e, s, r) {
  const i = Ft().journey, l2 = Ft().securityLevel;
  let c2;
  l2 === "sandbox" && (c2 = Ct("#i" + e));
  const y = l2 === "sandbox" ? Ct(c2.nodes()[0].contentDocument.body) : Ct("body");
  M.init();
  const u = y.select("#" + e);
  j.initGraphics(u);
  ...
  Fa(u, b, _, i.useMaxWidth), u.append("line").attr("x1", C).attr("y1", i.height * 4).attr("x2", _ - C - 4).attr("y2", i.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const n = g ? 70 : 0;
...
//# sourceMappingURL=journeyDiagram-4884cc8d-PA7FV5BN.js.map
