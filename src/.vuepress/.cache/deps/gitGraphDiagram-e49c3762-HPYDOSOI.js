...
// node_modules/.pnpm/mermaid@10.3.1/node_modules/mermaid/dist/gitGraphDiagram-e49c3762.js
var pe = function() {
  var r = function(q, m, b, k2) {
    for (b = b || {}, k2 = q.length; k2--; b[q[k2]] = m)
      ;
    return b;
    ...
    performAction: function(m, b, k2, i, v, e, W) {
      var t = e.length - 1;
      switch (v) {
        case 3:
          return e[t];
    ...
    parse: function(m) {
      var b = this, k2 = [0], i = [], v = [null], e = [], W = this.table, t = "", re = 0, ge = 0, Me = 2, de2 = 1, Ce = e.slice.call(arguments, 1), M = Object.create(this.lexer), Y = { yy: {} };
      ...
      function Se() {
        var j;
        return j = i.pop() || M.lex() || de2, typeof j != "number" && (j instanceof Array && (i = j, j = i.pop()), j = b.symbols_[j] || j), j;
      }
      for (var P, K, D, me, J = {}, ie, z, ke, se; ; ) {
        if (K = k2[k2.length - 1], this.defaultActions[K] ? D = this.defaultActions[K] : ((P === null || typeof P > "u") && (P = Se()), D = W[K] && W[K][P]), typeof D > "u" || !D.length || !D[0]) {
          var ue = "";
          se = [];
          for (ie in W[K])
...
` + M.showPosition() + `
Expecting ` + se.join(", ") + ", got '" + (this.terminals_[P] || P) + "'" : ue = "Parse error on line " + (re + 1) + ": Unexpected " + (P == de2 ? "end of input" : "'" + (this.terminals_[P] || P) + "'"), this.parseError(ue, {
            text: M.match,
        ...
        switch (D[0]) {
          case 1:
            k2.push(P), v.push(M.yytext), e.push(M.yylloc), k2.push(D[1]), P = null, ge = M.yyleng, t = M.yytext, re = M.yylineno, he = M.yylloc;
            break;
          case 2:
            if (z = this.productions_[D[1]][1], J.$ = v[v.length - z], J._$ = {
              ...
              return me;
            z && (k2 = k2.slice(0, -1 * z * 2), v = v.slice(0, -1 * z), e = e.slice(0, -1 * z)), k2.push(this.productions_[D[1]][0]), v.push(J.$), e.push(J._$), ke = W[k2[k2.length - 2]][k2[k2.length - 1]], k2.push(ke);
            break;
          case 3:
            return true;
        }
    ...
    var q = {
      EOF: 1,
      parseError: function(b, k2) {
        if (this.yy.parser)
          this.yy.parser.parseError(b, k2);
        else
          throw new Error(b);
      },
      ...
      unput: function(m) {
        ...
        return this.yylloc = {
          ...
          last_column: k2 ? (k2.length === i.length ? this.yylloc.first_column : 0) + i[i.length - k2.length].length - k2[0].length : this.yylloc.first_column - b
...
` + b + "^";
      ...
      next: function() {
        ...
        for (var v = this._currentRules(), e = 0; e < v.length; e++)
          if (k2 = this._input.match(this.rules[v[e]]), k2 && (!b || k2[0].length > b[0].length)) {
            if (b = k2, i = e, this.options.backtrack_lexer) {
              if (m = this.test_match(k2, v[e]), m !== false)
                return m;
              if (this._backtrack) {
                b = false;
                continue;
...
` + this.showPosition(), {
      ...
      performAction: function(b, k2, i, v) {
        switch (i) {
          case 0:
...
var Ee = {};
var We = function(r) {
  k.debug("options str", r), r = r && r.trim(), r = r || "{}";
  try {
    Ee = JSON.parse(r);
  } catch (a) {
    k.error("error while parsing gitGraph options", a.message);
  }
};
var Xe = function() {
  return Ee;
...
var Qe = function(r, a, o, p) {
  k.debug("Entering commit:", r, a, o, p), a = Bn.sanitizeText(a, Ft()), r = Bn.sanitizeText(r, Ft()), p = Bn.sanitizeText(p, Ft());
  const n = {
    id: a || U + "-" + be(),
    message: r,
    seq: U++,
  ...
  G = n, R[n.id] = n, L[A] = n.id, k.debug("in pushCommit " + n.id);
};
var Ze = function(r, a) {
  if (r = Bn.sanitizeText(r, Ft()), L[r] === void 0)
    L[r] = G != null ? G.id : null, Z[r] = { name: r, order: a ? parseInt(a, 10) : null }, we(r), k.debug("in createBranch");
  else {
    let o = new Error(
...
var $e = function(r, a, o, p) {
  r = Bn.sanitizeText(r, Ft()), a = Bn.sanitizeText(a, Ft());
  ...
  G = u, R[u.id] = u, L[A] = u.id, k.debug(L), k.debug("in mergeBranch");
};
var et = function(r, a, o) {
  if (k.debug("Entering cherryPick:", r, a, o), r = Bn.sanitizeText(r, Ft()), a = Bn.sanitizeText(a, Ft()), o = Bn.sanitizeText(o, Ft()), !r || R[r] === void 0) {
    let c = new Error(
  ...
  if (!a || R[a] === void 0) {
    ...
    G = u, R[u.id] = u, L[A] = u.id, k.debug(L), k.debug("in cherryPick");
  }
};
var we = function(r) {
  if (r = Bn.sanitizeText(r, Ft()), L[r] === void 0) {
...
function Te(r) {
  ...
  for (let n in L)
    L[n] === a.id && p.push(n);
  if (k.debug(p.join(" ")), a.parents && a.parents.length == 2) {
...
var rt = function() {
  ...
  L = {}, L[r] = null, Z = {}, Z[r] = { name: r, order: a }, A = r, U = 0, La();
};
var it = function() {
...
var _e = (r, a, o) => {
  const p = Na().gitGraph, n = r.append("g").attr("class", "commit-bullets"), c = r.append("g").attr("class", "commit-labels");
  let u = 0;
...
var ft = (r, a) => {
  const o = Na().gitGraph, p = r.append("g");
  a.forEach((n, c) => {
...
var bt = function(r, a, o, p) {
  ht();
  const n = Na(), c = n.gitGraph;
  k.debug("in gitgraph renderer", r + `
`, "id:", a, o), X = p.db.getCommits();
  ...
  }), _e(h, X, false), c.showBranches && ft(h, u), pt(h, X), _e(h, X, true), Oi.insertTitle(
    h,
    "gitTitleText",
    c.titleTopMargin,
...
//# sourceMappingURL=gitGraphDiagram-e49c3762-HPYDOSOI.js.map
