...
export const nav: DefaultTheme.Config['nav'] = [
    { text: '🏠 主页', link: '/' },
    {
        ...
        items: [
            ...
            { text: '实战训练', link: '/java-tutorial/in-action/20220625-1-5' },
        ]
    },
...

    {
        ...
        items: [
            ...
            { text: '数据结构与算法', link: '/cs-wiki/algo/20220503-datastructure-intro' },
        ]
    },

    {
        text: '🚀 基础教程',
        items: [
            { text: 'IDEA 教程', link: '/tutorial/idea/20220202-idea-guide' },
            { text: '博客搭建', link: '/tutorial/blog/20220401-hexo' },
            { text: '效率工具', link: '/tutorial/efficiency/20200511-windows-install-node' },
            { text: '软件设计师', link: '/tutorial/software-designer/20221024-computer-system' }
        ]
    },
