...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/gitbash-here.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/ssh-key.png)

一般执行上述命令之后，会生成 `id_rsa` 和 `id_rsa.pub` 两个文件，前者是我们私有的，而后者则是对外开放的。接着找到生成的 `.ssh` 的文件夹中的 id_rsa.pub 密钥，将内容复制；

![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/id-rsa.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/add-ssh-key.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/node-v.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/hexo-install.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/init-blog.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/blog-home.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/domain.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/config.png)

![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/repo-setting.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/gitee-repo.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/repo-gitee.png)

完成上述步骤之后，主要使用如下命令，就能将我们本地的内容推送到远程 Gitee 仓库了，去手动更新 Gitee Pages 后，然后在浏览器中访问：

> https://用户名.gitee.io

![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/gitee-home.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/new-blog.png)

2.  接着在 `blog/source/_posts` 目录下应该就会有创建好的以文章标题名命名的 Markdown 文件；

![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/article.png)

3.  接着打开该文件，编写你自己想要的内容即可；

![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/arti-context.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/arti-demo.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/doman-setting.png)
...
![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/page-setting.png)

比如我的域名为 `cunyu1943.site`，通过设置之后，我们就可以通过 https://cunyu1943.site 来访问我的博客了。

![](https://cunyu1943.github.io/static/imgs/article/blog-tutorial/20220401-hexo/blog-domain-home.png)
