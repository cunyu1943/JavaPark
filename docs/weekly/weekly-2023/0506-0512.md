...
![](https://cunyu1943.github.io/img/article/weekly-2023/hexo-theme-butterfly.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/echarts.png)

### [Magic Coder](http://www.magicalcoder.com/)

低代码应用开发平台，面向零基础、拖拽式、可视化，甚至零基础的人员都能搭建出想要的效果。

![](https://cunyu1943.github.io/img/article/weekly-2023/magiccoder.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/supercom.png)

### [Alfred](https://www.alfredapp.com/)

`Alfred` 是一款屡获殊荣的 `macOS` 应用程序，它通过热键、关键字、文本扩展等提高您的效率。搜索您的 `Mac` 和网络，并通过自定义操作来控制您的 `Mac`，从而提高工作效率。

![](https://cunyu1943.github.io/img/article/weekly-2023/alfred.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/microsoft-todo.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/edu-mirror.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/web-nav.png)

### [Badger](https://badges.toozhao.com/)

为你的网站生成独一无二的 `SVG` 图片，只要将该图片放到你网站的对应界面，就能通过它统计出该页面被访问的次数，一般用在 `Github` 主页统计访客数。

![](https://cunyu1943.github.io/img/article/weekly-2023/badger.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/microsoft-editor.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/Infinity.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/dark-reader.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/js-tips.png)
...
![](https://cunyu1943.github.io/img/article/weekly-2023/mdn-web-docs.png)

### [JavaFamily](https://github.com/AobingJava/JavaFamily)

【`Java` 面试 + `Java` 学习指南】 一份涵盖大部分 `Java` 程序员所需要掌握的核心知识。包含学习路线、`Java` 基础、计算机操作系统、计算机网络、框架、数据库等多方面的内容。

![](https://cunyu1943.github.io/img/article/weekly-2023/javafamily.png)
